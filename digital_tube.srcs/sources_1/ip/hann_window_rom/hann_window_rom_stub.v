...
// Command     : write_verilog -force -mode synth_stub -rename_top hann_window_rom -prefix
//               hann_window_rom_ hann_window_rom_stub.v
...
module hann_window_rom(clka, wea, addra, dina, douta)
