...
// Command     : write_verilog -force -mode synth_stub -rename_top imag_square_mult -prefix
//               imag_square_mult_ real_square_mult_stub.v
...
module imag_square_mult(CLK, A, B, CE, SCLR, P)
