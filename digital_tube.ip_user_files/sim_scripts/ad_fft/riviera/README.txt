...
#
# Generated by export_simulation on Sun Oct 26 17:01:41 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './ad_fft.sh' script.
...
./ad_fft.sh -noclean_files

For more information on the script, please type './ad_fft.sh -help'.
